...
module.exports = exports = nano = function database_module(cfg) {
    ...
    function relax(opts, callback) {
        ...
        var log = logging()
            ...
            , req = { method: (opts.method || 'GET'), headers: headers, uri: cfg.url }
            , status_code
            , parsed
            , rh
            ;
            ...
            if (!/^_design/.test(opts.doc)) {
                try {
                    ...
                    return errs.handle(errs.merge(error,
                        { 'message': 'couldnt encode: ' + (opts && opts.doc) + ' as an uri', 'scope': 'nano', 'errid': 'encode_uri'
                        }), callback);
                }
            }
            else {
        ...
        if (!_.isEmpty(opts.params)) {
            try {
                    ...
                    if (key in opts.params) {
                        try {
                            ...
                            return errs.handle(errs.merge(err,
                                { 'message': 'bad params: ' + key + ' = ' + opts.params[key], 'scope': 'nano', 'errid': 'encode_keys'
                                }), callback);
                        }
                    }
                });
                ...
                return errs.handle(errs.merge(err6,
                    { 'messsage': 'params is not an object', 'scope': 'nano', 'errid': 'bad_params'
                    }), callback);
            }
            ...
            try {
                ...
                return errs.handle(errs.merge(err2,
                    { 'message': 'invalid params: ' + params.toString(), 'scope': 'nano', 'errid': 'encode_params'
                    }), callback);
            }
        }
            ...
            if (Buffer.isBuffer(opts.body) || opts.dont_stringify) {
                ...
                try {
                    ...
                    return errs.handle(errs.merge(err3,
                        { 'message': 'body seems to be invalid json', 'scope': 'nano', 'errid': 'encode_body'
                        }), callback);
                }
            } // json data
        }
        ...
        if (!callback) {
            try {
                ...
                return errs.handle(errs.merge(err4,
                    { 'message': 'request threw when you tried to stream', 'scope': 'request', 'errid': 'stream'
                    }), callback);
            }
        }
        ...
        try {
            var stream = request(req, function (e, h, b) {
                ...
                if (e) {
                    ...
                    errs.handle(errs.merge(e,
                        { 'message': 'error happened in your connection', 'scope': 'socket', 'errid': 'request'
                        }), callback);
                    return stream;
                }
                ...
                if (status_code >= 200 && status_code < 400) {
                    ...
                    errs.handle(errs.merge(errs.create(parsed),
                        { 'scope': 'couch', 'status_code': status_code, 'status-code': status_code, 'request': req, 'headers': rh, 'errid': 'non_200', 'message': parsed.reason || 'couch returned ' + status_code
                        }), callback);
                    return stream;
                }
            });
            ...
            return errs.merge(err5,
                { 'message': 'request threw when you tried to create the object', 'scope': 'request', 'errid': 'callback'
                });
        }
    }
    ...
    function auth_server(username, password, callback) {
        return relax(
            { method: 'POST', db: '_session', form: { 'name': username, 'password': password }, content_type: 'application/x-www-form-urlencoded; charset=utf-8'
            }, callback);
    }
    ...
    function updates(params, callback) {
        ...
        return relax(
            { method: 'GET', db: '_db_updates', params: params
            }, callback);
    }
    ...
    function compact_db(db_name, design_name, callback) {
        ...
        return relax(
            { db: db_name, doc: '_compact', att: design_name, method: 'POST' }, callback);
    }
    ...
    function changes_db(db_name, params, callback) {
        ...
        return relax(
            { db: db_name, path: '_changes', params: params, method: 'GET' }, callback);
    }
    ...
    function follow_db(db_name, params, callback) {
        ...
        if (!follow) {
            var stream = errs.handle(
                { 'message': 'follow is only supported on node 0.6+', 'scope': 'follow', 'errid': 'no_soup_for_you'
                }, callback);
    ...
    function replicate_db(source, target, opts, callback) {
        ...
        if (typeof target === 'object') {
            ...
            if (target_cfg.url && target_cfg.db) {
                ...
                return errs.handle(errs.create(
                    { 'message': 'replication target is invalid', 'scope': 'nano', 'errid': 'replication_target'
                    }), callback);
            }
        }
        if (typeof source === 'object') {
            ...
            if (source_cfg.url && source_cfg.db) {
                ...
                return errs.handle(errs.create(
                    { 'message': 'replication source is invalid', 'scope': 'nano', 'errid': 'replication_source'
                    }), callback);
            }
        }
        opts.source = source;
    ...
    function document_module(db_name) {
        ...
        function destroy_doc(doc_name, rev, callback) {
            return relax(
                { db: db_name, doc: doc_name, method: 'DELETE', params: {rev: rev} }, callback);
        }
        ...
        function get_doc(doc_name, params, callback) {
            ...
            return relax(
                { db: db_name, doc: doc_name, method: 'GET', params: params }, callback);
        }
        ...
        function head_doc(doc_name, callback) {
            return relax(
                { db: db_name, doc: doc_name, method: 'HEAD', params: {} }, callback);
        }
        ...
        function copy_doc(doc_src, doc_dest, opts, callback) {
            ...
            var params =
            { db: db_name, doc: doc_src, method: 'COPY', headers: { 'Destination': doc_dest }
            };
            if (opts.overwrite) {
        ...
        function list_docs(params, callback) {
            ...
            return relax(
                { db: db_name, path: '_all_docs', method: 'GET', params: params }, callback);
        }
        ...
        function fetch_docs(doc_names, params, callback) {
            ...
            return relax(
                { db: db_name, path: '_all_docs', method: 'POST', params: params, body: doc_names }, callback);
        }
        ...
        function view_docs(design_name, view_name, params, callback) {
            ...
            if (params && params.keys) {
                ...
                delete params.keys;
                return relax({db: db_name, path: view_path, method: 'POST', params: params, body: body}, callback);
            }
            else {
                return relax({db: db_name, path: view_path, method: 'GET', params: params}, callback);
            }
        }
        ...
        function show_doc(design_name, show_fn_name, docId, params, callback) {
            ...
            return relax({db: db_name, path: show_fn_path, method: 'GET', params: params}, callback);
        }
         ...
         * @param {params:object} additions to the querystring
         */
        function update_with_handler_doc(design_name, update_name, doc_name, body, callback) {
            ...
            return relax(
                { db: db_name, path: update_path, method: 'PUT', body: body }, callback);
        }
        ...
        function bulk_docs(docs, params, callback) {
            ...
            return relax(
                { db: db_name, path: '_bulk_docs', body: docs, method: 'POST', params: params}, callback);
        }
        ...
        function insert_multipart(doc, attachments, params, callback) {
            ...
            return relax(
                { db: db_name, method: 'PUT', content_type: 'multipart/related', doc: doc_name, params: params, multipart: multipart}, callback);
        }
        ...
        function get_multipart(doc_name, params, callback) {
            ...
            return relax({ db: db_name, method: 'GET', doc: doc_name, content_type: 'multipart/related', params: params}, callback);
        }
        ...
        function insert_att(doc_name, att_name, att, content_type, params, callback) {
            ...
            return relax(
                { db: db_name, att: att_name, method: 'PUT', content_type: content_type, doc: doc_name, params: params, body: att, dont_stringify: true}, callback);
        }
        ...
        function get_att(doc_name, att_name, params, callback) {
            ...
            return relax({ db: db_name, att: att_name, method: 'GET', doc: doc_name, params: params, encoding: null, dont_parse: true}, callback);
        }
        ...
        function destroy_att(doc_name, att_name, rev, callback) {
            if (typeof att_name !== 'string' && att_name !== '') {
                return errs.handle(errs.create(
                    { 'message': 'att_name is not a string', 'scope': 'nano', 'errid': 'bad_params'
                    }), callback);
            }
            return relax({ db: db_name, att: att_name, method: 'DELETE', doc: doc_name, params: {rev: rev}}, callback);
        }
        ...
        function view_docs_with_list(design_name, view_name, list_name, params, callback) {
            ...
            if (params && params.keys) {
                var body = {keys: params.keys};
                delete params.keys;
                return relax({db: db_name, path: list_path, method: 'POST', params: params, body: body}, callback);
            }
            else {
                return relax({db: db_name, path: list_path, method: 'GET', params: params}, callback);
            }
        }
        ...
        { info: function (cb) {
            ...
            , session: session, insert: insert_doc, get: get_doc, head: head_doc, copy: copy_doc, destroy: destroy_doc, bulk: bulk_docs, list: list_docs, fetch: fetch_docs, fetch_revs: fetch_revs, config: {url: cfg.url, db: db_name}, multipart: { insert: insert_multipart, get: get_multipart
        }, attachment: { insert: insert_att, get: get_att, destroy: destroy_att
        }, show: show_doc, atomic: update_with_handler_doc, updateWithHandler: update_with_handler_doc          // alias
        };
    ...
    public_functions =
    { db: { create: create_db, get: get_db, destroy: destroy_db, list: list_dbs, use: document_module   // alias
        , scope: document_module   // alias
        , compact: compact_db, replicate: replicate_db, changes: changes_db, follow: follow_db
    }, use: document_module, scope: document_module   // alias
        , request: relax, relax: relax             // alias
        , dinosaur: relax             // alias
        , auth: auth_server, session: session, updates: updates, follow_updates: follow_updates
    };
        ...
        if (/^https?:/.test(cfg)) {
            ...
            try {
                ...
                throw errs.merge(error,
                    { 'scope': 'init', 'message': 'couldn\'t read config file ' + cfg, 'errid': 'bad_file'
                    });
            }
        }
    }
    ...
    if (!(cfg && cfg.url)) {
        throw errs.create(
            { 'scope': 'init', 'message': 'no configuration with a valid url was given', 'errid': 'bad_url'
            });
    }
    ...
    path_array = path.pathname.split('/').filter(function (e) {
        return e;
    });
